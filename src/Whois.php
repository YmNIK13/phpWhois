...
use Algo26\IdnaConvert\Exception\{AlreadyPunycodeException, InvalidCharacterException, InvalidIdnVersionException};
...
class Whois extends WhoisClient
{
	 ...
	 * @throws InvalidIdnVersionException
	 */
	public function lookup(string $query = '', bool $is_utf = true)
	{
		// start clean
